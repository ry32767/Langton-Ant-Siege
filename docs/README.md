...
| [action-centric-contract.md](action-centric-contract.md) | v6 Action-Centric CPU の**実装契約**。view の追加フィールド・Action の形・24次元 Feature Encoder の凍結表・Reference League・`policy.json` の新スキーマ。engine / cpu / 学習 / 評価 / テストはこの文書だけを見て書ける |
